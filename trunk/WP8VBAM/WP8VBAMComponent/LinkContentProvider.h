...
class LinkDirect3DContentProvider : public Microsoft::WRL::RuntimeClass<
...
{
public:
	LinkDirect3DContentProvider(PhoneDirect3DXamlAppComponent::LinkDirect3DBackground^ controller);
...
private:
	PhoneDirect3DXamlAppComponent::LinkDirect3DBackground^ m_controller;
