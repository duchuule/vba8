    ...
    public partial class AutoBackupPage : PhoneApplicationPage
    {
        ...
        private void backupTypePicker_SelectionChanged_1(object sender, SelectionChangedEventArgs e)
        {
            if (initdone)
            {
                ...
                {
                    if (backupTypePicker.SelectedIndex != App.metroSettings.AutoBackupMode)
                    {
                        backupTypePicker.SelectedIndex = App.metroSettings.AutoBackupMode; //restore previous value
